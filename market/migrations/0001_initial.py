    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Imagen')),
                ...
                ('product1', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Producto 1')),
                ('product2', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Producto 2')),
                ('product3', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Producto 3')),
                ('product4', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Producto 4')),
                ('product5', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Producto 5')),
                ('product6', models.ImageField(blank=True, default='./staticfiles/core/img/ic-registra.png', null=True, upload_to='./staticfiles/market/img/company', validators=[core.validators.validate_file_size], verbose_name='Producto 6')),
                ('activity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='market.activity', verbose_name='Actividad')),
                ...
                ('subactivity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='market.subactivity', verbose_name='Actividad especifica')),
