# Generated by Django 3.1 on 2021-04-22 21:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Imagen')),
                ...
                ('product1', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Producto 1')),
                ('product2', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Producto 2')),
                ('product3', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Producto 3')),
                ('product4', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Producto 4')),
                ('product5', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Producto 5')),
                ('product6', models.ImageField(blank=True, default='company/default/noimage.jpg', null=True, upload_to='company', validators=[core.validators.validate_file_size], verbose_name='Producto 6')),
